...
10. Aprender sobre diseño y arquitectura de software: Aprender sobre principios de diseño y

 desarrollo, patrones de diseño GOF, Domain-Driven Design, Test-Driven Development, CQRS, Event Sourcing y patrones arquitectónicos como microservicios, serverless, etc. Aplicar estos conceptos al proyecto de la lista de tareas para mejorar su estructura y mantenibilidad.
